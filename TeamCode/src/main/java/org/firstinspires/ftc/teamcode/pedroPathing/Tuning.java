...
public class Tuning extends SelectableOpMode {
    ...
    public static void drawCurrent() {
        ...
        try {
            ...
            if (telemetryM != null) {
                telemetryM.debug("Drawing failed: " + e.getMessage());
            }
        }
    }
...
abstract class TuningOpMode extends OpMode {
    @Override
    public void stop() {
        stopRobot();
    }
 ...
 */
class LocalizationTest extends TuningOpMode {
 ...
 * @version 1.0, 5/6/2024
 */
class ForwardTuner extends TuningOpMode {
 ...
 */
class LateralTuner extends TuningOpMode {
    public static double DISTANCE = 48;
 ...
 * @version 1.0, 5/6/2024
 */
class TurnTuner extends TuningOpMode {
 ...
 */
class ForwardVelocityTuner extends TuningOpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralVelocityTuner extends TuningOpMode {
    private final ArrayList<Double> velocities = new ArrayList<>();
 ...
 * @version 1.0, 3/13/2024
 */
class ForwardZeroPowerAccelerationTuner extends TuningOpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralZeroPowerAccelerationTuner extends TuningOpMode {
    private final ArrayList<Double> accelerations = new ArrayList<>();
    public static double VELOCITY = 30;
    private double previousVelocity;
    private long previousTimeNano;
 ...
 */
class PredictiveBrakingTuner extends TuningOpMode {
 ...
 */
class TranslationalTuner extends TuningOpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class HeadingTuner extends TuningOpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class DriveTuner extends TuningOpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class Line extends TuningOpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/13/2024
 */
class CentripetalTuner extends TuningOpMode {
 ...
 */
class Triangle extends TuningOpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class Circle extends TuningOpMode {
 ...
 * @author Kabir Goyal
 */
class AnalogMinMaxTuner extends TuningOpMode {
 ...
 *
 */
class SwerveOffsetsTest extends TuningOpMode {
    boolean debugStringEnabled = false;
 ...
 *
 */
class SwerveTurnTest extends TuningOpMode {
    boolean debugStringEnabled = false;
 ...
 */
class OffsetsTuner extends TuningOpMode {
    @Override
    public void init() {
        follower.setStartingPose(new Pose(72,72));
        follower.update();
